...
<body>
    <div class="container">
        ...
        <div class="search-box">
            ...
            <li><button class="search-button" id="xuathang-button">Xuất hàng</button></li>
            <!-- <li><button id="xuathang-button">Xuất hàng</button></li> -->
            <!-- <button class="search-button" id="xuathangButton">Xuất hàng</button> -->
        </div>
    ...
    <div id="xuathang-popup" class="popup">
        <div class="popup-content">
            ...
            <form>
                ...
                <input type="date" placeholder="Ngày xuất">
    ...
    <script>
        // JavaScript
        function openPopup() {
            var popup = document.getElementById("xuathang-popup");
        ...
        // Gán sự kiện click cho nút "Xuất hàng"
        var xuathangButton = document.getElementById("xuathang-button");
        xuathangButton.addEventListener("click", openPopup);
    </script>
</body>
</html>
