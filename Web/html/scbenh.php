    ...
    <div class="container">
        ...
        <table class="data-table">
            ...
            <tbody>
                <tr>
                    <td>Cảm cúm</td>
                    <td>Cảm thấy ớn lạnh, đổ mồ hôi, Ho khan, viêm họng, đau đầu, mệt mỏi</td>
                    <td>vi rút cúm (Influenza virus)</td>
                </tr>
                <tr>
                    <td>Cảm lạnh</td>
                    <td>Ho, nhức đầu, đau cơ, sốt nhẹ, hắt xì</td>
                    <td>Kháng sinh< virus gây ra, trong đó phổ biến nhất là các virus thuộc chủng Rhinovirus, hoặc Enterovirus/td>
                </tr>
